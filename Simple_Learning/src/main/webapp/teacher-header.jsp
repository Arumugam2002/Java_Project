...
<%
    ...
    {
    	t = (Teacher) session.getAttribute("data");
    }
    ...
    <nav class="navbar navbar-expand-lg bg-white navbar-light shadow sticky-top p-0">
        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
            <div class="navbar-nav ms-auto p-4 p-lg-0">
                ...
                <div class="nav-item dropdown">
                    <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown"><%= t.getName() %></a>
                    <div class="dropdown-menu fade-down m-0">
                        <a href="teacher-profile.jsp" class="dropdown-item">Profile</a>
                        <a href="teacher-change-password.jsp" class="dropdown-item">Change Password</a>
                        <a href="teacher-logout.jsp" class="dropdown-item">Logout</a>
                        
                    </div>
                </div>
                
                
                <a href="teacher-contact-page.jsp" class="nav-item nav-link">Contact</a>
            </div>
